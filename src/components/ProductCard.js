...
const ProductCard = ({ product, compact, className }) => {
  ...
  if (compact) {
    return (
      <div className={`max-w-md h-96 mx-auto bg-white shadow-lg rounded-lg overflow-hidden ${className}`}>
        {/* Image Section */}
        ...
        <div className="px-4 py-2 space-y-2">
          ...
          <div className="flex space-x-2 items-center text-gray-700 font-semibold">
          ...
          <div className="flex flex-row">
            ...
            {product.amenities.length > 3 && (
              <div className="relative group">
                ...
                <div className="absolute -bottom-0 -left-0 mt-2 max-w-48 bg-white border border-gray-300 rounded-lg shadow-lg p-2 hidden group-hover:block">
  ...
  return (
    <div className={`max-w-3/4 mx-auto bg-white shadow-lg rounded-lg overflow-hidden flex ${className}`}>
      {/* Image Section */}
      ...
      {/* Description Section */}
      <div className="flex w-2/3 divide-x-2 divide-gray-200">
...
<div className="flex flex-row">
        ...
        {/* Price and Buy Button Section */}
        <div className="w-2/5 p-4 flex flex-col justify-end">
          <p className="text-xl font-bold text-orange-600">${product.price}</p>
          <button
            onClick={() => alert(`Buying ${product.name}...`)}
            className="px-4 py-2 bg-blue-500 text-white font-bold rounded-md hover:bg-blue-600 transition-colors"
